...
import { NewRegistrationContext } from "../../../Pages/Admin/NewRegistration/NewRegistration";
// import { NewRegistrationContext,NewRegistration } from "../../../Pages/Admin/NewRegistration/NewRegistration";
...
export const TableRow = ({
  ...
  let { modal, setModal, page, setPage, setId,setUrl} = useContext(NewRegistrationContext);
